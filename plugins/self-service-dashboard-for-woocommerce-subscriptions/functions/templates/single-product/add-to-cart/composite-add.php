...
<form style="display: none" method="post" enctype="multipart/form-data" class="cart cart_group composite_form cp-no-js wpr-add-composite-<?php echo absint( $product_id ); ?> <?php echo esc_attr( $classes ); ?>">
	<?php
	...
	?>
	<input type="button" data-id="<?php echo absint( $order_id ); ?>" data-subscription-in="<?php echo absint( $product_id ); ?>" class="wpr-subscription-composite-add-submit" value="<?php echo esc_html__( 'Add to subscription', 'self-service-dashboard-for-woocommerce-subscriptions' ); ?>"/>
	...
	<?php
	/**
	 * After add to cart composite form
	 *
	 ...
	 * @since 1.0.0
	 */
	do_action( 'sdd_after_composite_product_form', $order_id, $product_id );
	?>
